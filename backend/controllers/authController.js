...
exports.register = async (req, res) => {
  ...
  connection.query(queryCheckEmail, [email], async (err, results) => {
    ...
    const queryInsertUser = 'INSERT INTO users (nombre, apellido, edad, genero, email, contrasena) VALUES (?, ?, ?, ?, ?, ?)';
    connection.query(queryInsertUser, [nombre, apellido, edad, genero, email, hashedPassword], (err, result) => {
      if (err) {
